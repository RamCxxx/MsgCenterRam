package com.ram.msgcenter.cron.pending;
...
import com.ram.msgcenter.cron.config.CronAsyncThreadPoolConfig;
import com.ram.msgcenter.cron.constants.PendingConstant;
import com.ram.msgcenter.cron.vo.CrowdInfoVo;
...
import com.ram.msgcenter.support.pending.AbstractLazyPending;
import com.ram.msgcenter.support.pending.PendingParam;
...
public class CrowdBatchTaskPending extends AbstractLazyPending<CrowdInfoVo> {
    ...
    public CrowdBatchTaskPending() {
        ...
        pendingParam.setQueue(new LinkedBlockingQueue(PendingConstant.QUEUE_SIZE))
                ...
                .setNumThreshold(ramMsgConstant.BATCH_RECEIVER_SIZE)
