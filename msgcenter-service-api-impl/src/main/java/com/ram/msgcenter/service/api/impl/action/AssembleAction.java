...
import com.ram.msgcenter.dto.model.ContentModel;
...
import com.ram.msgcenter.support.utils.ContentHolderUtil;
import com.ram.msgcenter.support.utils.TaskInfoUtils;
...
public class AssembleAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        try {
            ...
            if (!messageTemplate.isPresent() || messageTemplate.get().getIsDeleted().equals(ramMsgConstant.TRUE)) {
