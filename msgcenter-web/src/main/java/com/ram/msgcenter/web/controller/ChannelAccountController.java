...
import com.ram.msgcenter.support.domain.ChannelAccount;
import com.ram.msgcenter.web.annotation.RamAspect;
import com.ram.msgcenter.web.annotation.RamResult;
import com.ram.msgcenter.web.service.ChannelAccountService;
...
//        }
        channelAccount.setCreator(StrUtil.isBlank(channelAccount.getCreator()) ? ramMsgConstant.DEFAULT_CREATOR : channelAccount.getCreator());
...
//            throw new CommonException(RespStatusEnum.NO_LOGIN.getCode(), RespStatusEnum.NO_LOGIN.getMsg());
//        }
        creator = StrUtil.isBlank(creator) ? ramMsgConstant.DEFAULT_CREATOR : creator;
