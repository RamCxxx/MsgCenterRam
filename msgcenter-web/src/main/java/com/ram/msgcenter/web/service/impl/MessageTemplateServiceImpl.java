package com.ram.msgcenter.web.service.impl;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.ram.msgcenter.constant.CommonConstant;
import com.ram.msgcenter.constant.ramMsgConstant;
import com.ram.msgcenter.cron.xxl.entity.XxlJobInfo;
import com.ram.msgcenter.cron.xxl.service.CronTaskService;
import com.ram.msgcenter.cron.xxl.utils.XxlJobUtils;
import com.ram.msgcenter.enums.AuditStatus;
import com.ram.msgcenter.enums.MessageStatus;
import com.ram.msgcenter.enums.RespStatusEnum;
import com.ram.msgcenter.enums.TemplateType;
...
public class MessageTemplateServiceImpl implements MessageTemplateService {
    ...
    public Page<MessageTemplate> queryList(MessageTemplateParam param) {
        ...
        String creator = StrUtil.isBlank(param.getCreator()) ? ramMsgConstant.DEFAULT_CREATOR : param.getCreator();
    ...
    private void initStatus(MessageTemplate messageTemplate) {
        messageTemplate.setFlowId(StrUtil.EMPTY)
                ...
                .setCreator(StrUtil.isBlank(messageTemplate.getCreator()) ? ramMsgConstant.DEFAULT_CREATOR : messageTemplate.getCreator())
                .setUpdator(StrUtil.isBlank(messageTemplate.getUpdator()) ? ramMsgConstant.DEFAULT_UPDATOR : messageTemplate.getUpdator())
                .setTeam(StrUtil.isBlank(messageTemplate.getTeam()) ? ramMsgConstant.DEFAULT_TEAM : messageTemplate.getTeam())
                .setAuditor(StrUtil.isBlank(messageTemplate.getAuditor()) ? ramMsgConstant.DEFAULT_AUDITOR : messageTemplate.getAuditor())
